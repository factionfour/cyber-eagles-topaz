...
public class Robot {
    ...
    int PICKUP_BLOCK_POS_X = 30;//ESTIMATE ONLY
    int PICKUP_BLOCK_POS_Y = 276;//ESTIMATE ONLY
    int PICKUP_BLOCK_POS_INTAKE_X = 42;//ESTIMATE ONLY

    int PARK_LEFT_AUTO_POS_1_X = 141;//ESTIMATE ONLY
    int PARK_LEFT_AUTO_POS_1_Y = 257;//ESTIMATE ONLY

    int PARK_LEFT_AUTO_POS_2_X = 160;//ESTIMATE ONLY
    int PARK_LEFT_AUTO_POS_2_Y = 227;//ESTIMATE ONLY
